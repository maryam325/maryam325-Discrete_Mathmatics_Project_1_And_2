    ...
    class program
    {
        static void Main(string[] args)
        {
            ...
            for (int i = start; i <= end; i++)     // To Check All The Numbers Between The Given Numbers.
            {
                ...
                {
                    if (i % j == 0)  //If The Number Has A Divisior Less Than Or Equal To The square Of The Number, Then It's Not A Prime Number So Increase The Divisior Counter By 1 and Exit The Loop.    
                    {
                        Divisor_Counter++;    
                        break;           
                    }
